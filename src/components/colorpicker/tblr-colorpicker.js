        ...
        ${colors.map(color => {
          ...
          return `
            <button
              ...
              ${disabled ? 'disabled' : ''}
            >
              <svg class="check" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
